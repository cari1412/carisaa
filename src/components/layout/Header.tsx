    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 sm:p-6 lg:px-8" aria-label="Global">
        <div className="flex items-center gap-x-8">
          ...
          {/* Navigation links - показываем только для неавторизованных на экранах >= 672px */}
          {!user && (
        ...
        {/* Desktop user menu - для авторизованных пользователей на всех устройствах */}
        {!loading && user && (
        ...
        {!loading && !user && (
          <>
            ...
            {/* Mobile версия (меньше 672px) */}
            <div className="flex min-[672px]:hidden">
              <button
                type="button"
